...
function EntityWalkState:update(dt)
    ...
    elseif self.entity.direction == 'up' then
        ...
        if self.entity.y <= MAP_RENDER_OFFSET_Y + TILE_SIZE - self.entity.height /
            2 then
            self.entity.y =
                MAP_RENDER_OFFSET_Y + TILE_SIZE - self.entity.height / 2
            self.bumped = true
        end
...
function EntityWalkState:processAI(params, dt)
    local battlefield = params.battlefield
    ...
    elseif self.movementTimer > self.moveDuration then
        ...
        if math.random(3) == 1 then
            ...
            self.entity:changeAnimation('walk-' ..
                                            tostring(self.entity.direction))
        end
    end
...
function EntityWalkState:render()
    ...
    love.graphics.draw(gTextures[anim.texture],
                       ...
                       math.floor(self.entity.y - self.entity.offsetY), 0,
                       1 / 2, 1 / 2)
